...
class DeclinedRequestsBody extends StatefulWidget {
  const DeclinedRequestsBody({
    Key? key,
  }) : super(key: key);

  @override
  State<DeclinedRequestsBody> createState() => _DeclinedRequestsBodyState();
}

class _DeclinedRequestsBodyState extends State<DeclinedRequestsBody> {
