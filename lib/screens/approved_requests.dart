...
import 'package:admin/screens/request_details_page.dart';
...
class ApprovedRequestsBody extends StatefulWidget {
  const ApprovedRequestsBody({
    Key? key,
  }) : super(key: key);

  @override
  State<ApprovedRequestsBody> createState() => _ApprovedRequestsBodyState();
}

class _ApprovedRequestsBodyState extends State<ApprovedRequestsBody> {
                    ...
                    SizedBox(
                      ...
                      child: DataTable2(
                        ...
                        rows: List.generate(
                          ...
                          (index) =>
                              approvedRequestDataRow(context, requests[index]),
                        ),
                      ),
                    ),
                  ],
  ...
  DataRow approvedRequestDataRow(BuildContext context, Request requestInfo) {
    ...
    return DataRow(cells: [
      ...
      DataCell(
        ...
        //         descriptionP = requestInfo.description!;
        //         startdateP = requestInfo.startdate!;
        //         applicationtimeanddateP = requestInfo.date!.toString();
        //         enddateP = requestInfo.enddate!;
        //         statusP = requestInfo.status!;
